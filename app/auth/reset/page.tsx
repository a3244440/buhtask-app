...
export default function ResetPasswordPage() {
  ...
  const inputClass = "w-full px-4 py-3 border border-gray-200 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none text-sm bg-white";
            ...
            <>
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <input type="password" placeholder="••••••••" value={confirm} onChange={e => setConfirm(e.target.value)} className={inputClass} />
                </div>
