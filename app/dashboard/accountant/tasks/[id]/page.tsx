    ...
    <div className="min-h-screen bg-[#F8FAFC]" style={{ fontFamily: 'Inter, sans-serif' }}>
      ...
      <div className="max-w-2xl mx-auto px-4 py-16 text-center">
        <div className="bg-white rounded-2xl border border-gray-100 p-10 shadow-sm">
          ...
          <button onClick={() => router.push('/dashboard/accountant')} className="px-5 py-2.5 bg-blue-600 text-white rounded-xl text-sm font-semibold hover:bg-blue-700">← Назад в кабинет</button>
        </div>
      </div>
    </div>
  );
    ...
    <div className="min-h-screen bg-[#F8FAFC]" style={{ fontFamily: 'Inter, sans-serif' }}>
      ...
      <main className="max-w-2xl mx-auto px-4 sm:px-6 py-8">
        ...
        {success ? (
          ...
          <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6">
            <h2 className="font-semibold text-gray-900 mb-5 flex items-center gap-2"><Send className="w-4 h-4 text-blue-600"/> Отправить отклик</h2>
            <div className="space-y-4">
              ...
              <div>
                ...
                <textarea rows={5} value={letter} onChange={e => setLetter(e.target.value)} placeholder="Расскажите о вашем опыте..." className={inp + ' resize-none'}/>
              </div>
