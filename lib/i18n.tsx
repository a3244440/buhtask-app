...
const translations: Record<string, Record<Lang, string>> = {
  ...
  'inc910.taxToPay': { ru: 'Единый налог (ИПН)', kz: 'Бірыңғай салық (ЖТС)', en: 'Single tax (IIT)' },
  ...
  'inc910.socDesc': { ru: 'Ежемесячные платежи от заявленного дохода (минимум 1 МЗП = 85 000 ₸)', kz: 'Мәлімделген кірістен айлық төлемдер (кемінде 1 ЕАЖ = 85 000 ₸)', en: 'Monthly payments from declared income (min 1 MW = 85,000 ₸)' },
  'inc910.socDeclared': { ru: 'Заявленный доход (в месяц)', kz: 'Мәлімделген кіріс (айына)', en: 'Declared income (monthly)' },
