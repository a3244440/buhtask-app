...
const translations: Record<string, Record<Lang, string>> = {
  ...
  'inc910.taxNote': { ru: 'Ставка 4% с 2026 г. (регион может установить 2–6%). Соцналог упразднён. Соцплатежи «за себя» (ОПВ, СО, ВОСМС) считаются отдельно от 1 МЗП. Проверьте ставку своего региона в кабинете salyk.kz.', kz: '2026 жылдан 4% (аймақ 2–6% белгілеуі мүмкін). Әлеуметтік салық жойылды. «Өзі үшін» төлемдер бөлек есептеледі.', en: 'Rate 4% since 2026 (region may set 2–6%). Social tax abolished. Personal social payments calculated separately.' },
